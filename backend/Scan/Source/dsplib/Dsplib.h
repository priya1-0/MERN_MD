...
short* cfft_offplace_SCALE(DATA *x, DATA *y, ushort nx);
short* cfft_offplace_NOSCALE(DATA *x, DATA *y, ushort nx);
short* cifft_offplace_SCALE (DATA *x, DATA *y, ushort nx);
short* cifft_offplace_NOSCALE (DATA *x, DATA *y, ushort nx);
...
#define cfft_offplace(x,nx,ny, type)   cfft_offplace_##type(x,nx, ny)
#define cifft_offplace(x,nx,ny, type)   cifft_offplace_##type(x,nx, ny)
