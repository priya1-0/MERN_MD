...
************************************************************************
 ...
 MODULE: Application Interrogation Module for the Phoenix (nEw3 Value) Family.
...
ait_KappaDeviceMemoryRange aim_Phoenix_Table[] =
{
//
...
***********************************************************************
 ...
 FUNCTION:   aim_PhoenixPreInterrogate
...
***********************************************************************
 ...
 FUNCTION:   aim_PhoenixInterrogate

 DESCRIPTION:
Interrogate a Phoenix Device.
...
void aim_PhoenixInterrogate(void)
{
    ...
    aim_KappaRead(aim_Phoenix_Table);
