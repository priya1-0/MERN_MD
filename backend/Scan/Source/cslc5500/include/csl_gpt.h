...
*	 Modified:	03/12/2003 Modified register names and fields
*                       as per SPRU618A.  
* 
*------------------------------------------------------------------------------ 
...
/*  GPTCTL1 field values  */ 
	...
	#define GPT_GPTCTL1_PWID_DEFAULT		GPT_GPTCTL1_PWID_INACTIVE_1CYCLES 
	...
	#define GPT_GPTCTL10_PWID_DEFAULT		GPT_GPTCTL1_PWID_INACTIVE_1CYCLES 
	...
	#define GPT_GPTCTL11_PWID_DEFAULT		GPT_GPTCTL1_PWID_INACTIVE_1CYCLES 
...
#define GPT_GPTGCTL1_RMK(psc34,timmode,tim34rs,tim12rs)\
 ((Uint16) ( \
...
#define GPT_GPTGCTL1_RMKS(psc34_sym,timmode_sym,tim34rs_sym,tim12rs_sym)\
 ((Uint16) ( \
