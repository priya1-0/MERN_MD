...
/*  WDTCTL1 field values  */
	...
	#define WDTIM_WDTCTL1_PWID_DEFAULT		WDTIM_WDTCTL1_PWID_INACTIVE_1CYCLES 
...
#define WDTIM_WDTGCTL1_RMK(psc34,timmode,tim34rs,tim12rs)\
 ((Uint16) ( \
...
#define WDTIM_WDTGCTL1_RMKS(psc34_sym,timmode_sym,tim34rs_sym,tim12rs_sym)\
 ((Uint16) ( \
...
#define WDTIM_initDual32(h, dt1ctl, dt2ctl,dt1prd, dt2prd, dt2prsc)\
...
#define WDTIM_initChained32(h,gctl, ctl1, prdHigh, prdLow)\
...
IDEF WDTIM_Handle WDTIM_open(void) {
  ...
  return (WDT_Handle)(&(CSL_WDTIM_DATA));
}
/*----------------------------------------------------------------------------*/
...
IDEF void WDTIM_wdStart(WDTIM_Handle hWdt) {
 Uint16 old_wdtcr2;
 int old_intm;
  ioport WDT_RegObj *regPtr =((CSL_WdtimDataObj *)(hWdt))->regs;

  old_intm = IRQ_globalDisable();

  old_wdtcr2 = PREG16(regPtr->wdtwctl2);

  regPtr->wdtwctl2 = WDTIM_WDTWCTL2_WDKEY_PREACTIVE;
  regPtr->wdtwctl2 = (old_wdtcr2 & _WDTIM_WDTWCTL2_WDKEY_CLR)
                           | WDTIM_WDTWCTL2_WDKEY_ACTIVE;  
