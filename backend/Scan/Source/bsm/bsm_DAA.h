...
/* DAA GPIO PINS **************************************************************/
//DAA RESET = P5 = GPIO0
#define DAA_RESET      GPIO_PIN0                          // bit mask for the I/O pin
#define DAA_RESET_Addr _GPIO_IODATA
#define DAA_RESET_Dir  _GPIO_IODIR
...
// Macros to reset the DAA
#define reset_DAA()     (DAA_RESET_Addr &= ~(DAA_RESET))
#define not_reset_DAA() (DAA_RESET_Addr |= (DAA_RESET))
